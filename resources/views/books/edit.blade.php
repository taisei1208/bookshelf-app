<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <!-- ISBN検索 -->
            <div
                class="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-100 shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
        ...
        <script>
            document.getElementById('fetch-btn').addEventListener('click', async function () {
                ...
                try {
                    ...
                    if (!response.ok) {
                        errorEl.textContent = data.errors?.isbn?.[0] ?? data.message;
